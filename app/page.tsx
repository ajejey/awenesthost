...
//       tl.to(bird, {
//         x: '100vw', // Move to the right edge of the screen
//         y: '200px', // Move down slightly
//         rotation: 180, // Rotate as it moves
//         ease: 'power1.inOut',
//       })
//       .to(bird, {
//         x: '0', // Move to the left edge of the screen
//         y: '500px', // Move further down
//         rotation: 360,
//         ease: 'power1.inOut',
//       })
//       .to(bird, {
//         x: '100vw', // Move to the right edge of the screen again
//         y: '800px', // Move further down
//         rotation: 540,
//         ease: 'power1.inOut',
//       })
//       .to(bird, {
//         x: '50vw', // Center horizontally
//         y: '100vh', // Move to the bottom of the viewport
//         rotation: 720,
//         ease: 'power1.inOut',
//       });
//     }
//   }, []);
  ...
  return (
    <main className="min-h-screen bg-gray-100 font-sans antialiased">
      {/* <img
        id="flying-bird"
        src="/images/bird.svg"
        alt="Flying Bird"
        className="fixed top-20 left-0 w-20 h-20 z-50 pointer-events-none"
      /> */}
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-90 shadow-lg py-4 px-6 md:px-12 flex justify-between items-center backdrop-blur-sm">
        ...
        <div className="hidden md:flex space-x-6 text-gray-700">
          <a href="#about-us" className="hover:text-sky-700 transition duration-300">About Us</a>
      ...
      {/* About Us Section: Introducing AweNestHost™ */}
      {/* About Us Section: Creative Design */}
      <section id="about-us" className="py-20 px-6 md:px-12 bg-gradient-to-br from-gray-50 to-white text-gray-800">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          {/* Left Column: Image */} 
          <div className="md:w-1/2 animate-fade-in-left">
            <img
              src="https://images.unsplash.com/photo-1626178793926-22b28830aa30?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="AweNestHost Team or Property" 
              className="rounded-3xl shadow-2xl object-cover w-full h-96 md:h-auto transform hover:scale-105 transition-transform duration-500 ease-out"
            />
          </div>
          {/* Right Column: Text Content */} 
          <div className="md:w-1/2 text-center md:text-left animate-fade-in-right">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
              About <span className="text-sky-500">AweNestHost™</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
              AweNestHost™ is a dedicated team of professionals committed to excellence in hospitality. Founded on principles of integrity and superior service, we strive to exceed expectations in every aspect of property management.
            </p>
